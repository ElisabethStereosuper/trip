<?php if( get_theme_mod( 'asw_header_topbar', true ) && ( has_nav_menu('topbar_navigation') || get_theme_mod('asw_header_socials', false) ) ) { ?>
	<div id="topbar">
		<div class="container">
			<div class="my-table">
				<div class="my-tr">
...
<header id="header" class="header1 clearfix">
	<div class="<?php echo esc_attr(get_theme_mod('asw_header_grid','container')); ?>">
	...
	<div class="navigation_wrapper">
		<div class="<?php echo esc_attr(get_theme_mod('asw_header_grid','container')); ?>">
			<div class="span12">
				...
				<?php } ?>
				<nav id="navigation" class="<?php echo esc_attr(get_theme_mod('asw_nav_textalign','textcenter')).' '.esc_attr(get_theme_mod('asw_header_dropdown_style','dark')); ?>">
